                ...
                <footer className="footer">
                    <div id="wporg-footer">
                        <div className="container">
                            ...
                            <ul>
                                <li><span className="dashicons dashicons-twitter"></span><a href="https://twitter.com/WordPress" title="Follow @WordPress on Twitter">@WordPress</a></li>
                                <li><span className="dashicons dashicons-facebook"></span><a href="https://www.facebook.com/WordPress/" title="Like WordPress on Facebook">WordPress</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="copyright">
                            <p>
                               Developed by <strong>Benjamin Zekavica</strong>. All rights reserved!
                            </p>
                        </div>
                    </div>
                </footer>
